    ...
    >
      ...
      <div className="lg:grid-cols-[5fr_7fr] grid ">
        ...
        <form className="contact__form" onSubmit={handleSubmit}>
          <div className="contact__form-group grid-cols-1 sm:grid-cols-2 grid">
            <div className="contact__form-div">
              <label className="contact__form-tag uppercase tracking-[0.05em] text-titleColor dark:text-titleColorDark">
                Your Full Name <b className="!text-primaryColor">*</b>
              </label>
              <input
                type="text"
                name="name"
            ...
            <div className="contact__form-div">
              <label className="contact__form-tag uppercase tracking-[0.05em] text-titleColor dark:text-titleColorDark">
                Your Email Address <b className="!text-primaryColor">*</b>
              </label>
              <input
                type="email"
                name="email"
          ...
          <div className="contact__form-div">
            <label className="contact__form-tag uppercase tracking-[0.05em] text-titleColor dark:text-titleColorDark">
              Your Subject <b className="!text-primaryColor">*</b>
            </label>
            <input
              name="subject"
              value={form.subject}
          ...
          <div className="contact__form-div contact__form-area">
            <label className="contact__form-tag uppercase tracking-[0.05em] text-titleColor dark:text-titleColorDark">
              Your Message <b className="!text-primaryColor">*</b>
            </label>
            <textarea
              name="message"
              value={form.message}
